...
internal static class DiscoveredTestNodeFactory
{
        ...
        string? skipOverride = null)
    {
        ...
        {
            Uid = GetDisplayName(method, testAttr), // TODO: $"{testClassType.FullName}+{method.Name}",
            ...
            TestFileProperty = new TestFileLocationProperty(testAttr.FilePath, new LinePositionSpan(
                new LinePosition(testAttr.LineNumber, 0),
                new LinePosition(testAttr.LineNumber, 0)))
        };
        ...
        testNode.Properties.Add(testNode.TestFileProperty);
